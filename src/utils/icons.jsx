 ...
 * 
 * Common SVG icons used across the component library and demo app.
 * All icons accept standard SVG props and default to 16px size for demo use.
 */
 ...
 * Success/Check Icon
 */
export const SuccessIcon = ({ size = 20, ...props }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
 ...
 * Info Icon
 */
export const InfoIcon = ({ size = 20, ...props }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <circle cx="12" cy="12" r="10"></circle>
 ...
 * Danger/Error Icon
 */
export const DangerIcon = ({ size = 20, ...props }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <circle cx="12" cy="12" r="10"></circle>
 ...
 * Table Icon
 */
export const TableIcon = ({ size = 16, ...props }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
 ...
 * Diamond Icon
 */
export const DiamondIcon = ({ size = 20, ...props }) => (
